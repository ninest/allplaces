  ...
  const sidebar = (
    <div>
      <TransparentContainer
        className={clsx("px-5 pt-4 sticky top-0", {
          "pb-2": showSearchFilters,
          "pb-4": !showSearchFilters,
        })}
      >
        <form className="space-y-3">
          <fieldset className="flex items-stretch focus-within:form-field-focus-ring">
            <input
              type="text"
              value={searchQuery}
    ...
    <>
      ...
      <main>
        ...
        <div className="hidden md:flex">
          <aside className="h-screen md:w-[300px] lg:w-[400px] md:border-r sticky top-0 overflow-y-scroll">
            <div>{sidebar}</div>
          </aside>
